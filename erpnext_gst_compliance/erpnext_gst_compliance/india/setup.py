...
import os
import erpnext
from erpnext.erpnext.accounts.utils import FiscalYearError, get_fiscal_year
...
from erpnext_gst_compliance.erpnext_gst_compliance.india import states
...
def setup_company_independent_fixtures(patch=False):
	...
	frappe.enqueue("erpnext_gst_compilance.erpnext_gst_compilance.india.setup.add_hsn_sac_codes", now=frappe.flags.in_test)
